...
export default function SpecialFunctionsTable() {
   ...
   const handleRemovePersonsByHeight = async () => {
      ...
      try {
         ...
         const response = await axios.post(link,{}, {params: {height: removePersonsByHeight},
            headers: headers
         });
         ...
         <Grid container sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
            <Grid item sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
               <Grid container sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                  <Grid item sx={{
                     ...
                     <StyleButton text="Get Count With Hair Color" onclick={handleGetCountWithHairColor} disabled={isFetching} type="button" />
                     <TextField
                         margin="dense"
                         type='text'
                         select
                  ...
                  <Grid item sx={{
                     ...
                     <StyleButton text="Get Count With Eye Color" onclick={handleGetCountWithEyeColor} disabled={isFetching} type="button" />
                     <TextField
                         margin="dense"
                         type='text'
                         select
            ...
            <Grid container sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
               <Grid item sx={{
                  ...
                  <StyleButton text="Get Persons With Birthday Less Than" onclick={handleGetBirthdayLessThan} disabled={isFetching} type="button" />
                  <Input
                      margin="dense"
                      type='text'
                      fullWidth
               ...
               <Grid item sx={{
                  ...
                  <StyleButton text="Get Persons With Names Starts With" onclick={handleGetNameStartsWith} disabled={isFetching} type="button" />
                  <Input
                     margin="dense"
                     type='text'
                     fullWidth
            ...
            <Grid container sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
               <Grid item sx={{
                  ...
                  <StyleButton text="Remove Persons By Height" onclick={handleRemovePersonsByHeight} disabled={isFetching} type="button" />
                  <Input
                      margin="dense"
                      type='number'
                      fullWidth

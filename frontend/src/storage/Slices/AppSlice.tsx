...
>(
    ...
    async (_, thunkAPI) => {
       await new Promise(resolve => setTimeout(resolve, 100));
       try {
          const link = "http://localhost:8080/person/all";
...
>(
   ...
   async ({ name, coordinatesId, eyeColor, hairColor, locationId, height, birthday, nationality, adminCanModify }, thunkAPI) => {
      await new Promise(resolve => setTimeout(resolve, 100));
      try {
         const link = `http://localhost:8080/person`;
         const params = {
...
>(
   ...
   async ({ id, name, coordinatesId, eyeColor, hairColor, locationId, height, birthday, nationality, adminCanModify }, thunkAPI) => {
      await new Promise(resolve => setTimeout(resolve, 100));
      try {
...
export const { clearState, clearAllStates, setCoordinatesPage, setUpdatedCoordinate, setLocationPage, setUpdatedLocation,
   setPersonPage, setUpdatedPerson, setAdminRequestPage, setFetching, setError, setErrorMessage
} = AppSlice.actions;
